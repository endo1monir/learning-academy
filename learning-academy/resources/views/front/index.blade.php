                ...
                <section class="special_cource padding_top">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-4">
                                <div class="single_special_cource">
                                    ...
                                    <div class="special_cource_text">
                                        ...
                                        <p>Which whose darkness saying were life unto fish wherein all fish of together
                                            called</p>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="single_special_cource">
                                    <img src="{{ asset('front') }}/img/special_cource_3.png" class="special_img"
                                        alt="">
                                    <div class="special_cource_text">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8 col-xl-4 col-sm-8 align-self-center">
                                                <div class="testimonial_slider_text">
                                                    <p>Behold place was a multiply creeping creature his domin to thiren
                                                        open void
